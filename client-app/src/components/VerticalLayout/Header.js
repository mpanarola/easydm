...
import logoSm from "../../assets/images/users/avatar-2.jpg";
            ...
            <div>
              <div className="navbar-brand-box">
                ...
                <Link to="/" className="logo logo-light">
                  <span className="logo-sm">
                    {/* <img src={logoSm} alt="" height="20" style={{color: "white", marginTop: "20px", fontWeight: "bold"}} />
                     */}
                     <h2 style={{color: "white", marginTop: "20px", fontWeight: "bold"}}>EasyDM</h2>
                  </span>
                  <span className="logo-lg">
